...
<html>
    ...
    <body>
        ...
        <div id="show-sport" class="content scaffold-show" role="main">
            ...
            <f:display bean="sport" />
            <g:form resource="${this.sport}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sport}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
